...
class Ayyappan extends StatefulWidget {
  late final String godname;

  Ayyappan({required this.godname});

  @override
  State<Ayyappan> createState() => _AyyappanState();
}

class _AyyappanState extends State<Ayyappan> {
