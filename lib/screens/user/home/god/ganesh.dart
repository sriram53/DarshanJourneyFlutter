...
class GaneshScreen extends StatefulWidget {
  late final String godname;

  GaneshScreen({required this.godname});

  @override
  State<GaneshScreen> createState() => _GaneshScreenState();
}

class _GaneshScreenState extends State<GaneshScreen> {
