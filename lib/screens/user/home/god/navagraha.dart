...
class Navagraha extends StatefulWidget {
  late final String godname;

  Navagraha({required this.godname});

  @override
  State<Navagraha> createState() => _NavagrahaState();
}

class _NavagrahaState extends State<Navagraha> {
